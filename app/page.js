...
export default function Home() {
  ...
  return (
      ...
      <><Script
      strategy="lazyOnload"
      src={'https://www.googletagmanager.com/gtag/js?id=G-CL6HXJBD10'} /><Script
        strategy="lazyOnload">
        {`
            ...
            {icons.map((icon, index) => (
              <Box
                ...
                sx={{
                  ...
                  alignItems: "center",
                  justifyContent: "center",
                  animation: `float ${2 + index * 0.5}s ease-in-out infinite alternate`, //animation named float, duration is 2 to 3.5 seconds based on index of icon
                  "@keyframes float": {
                    "0%": {
